...
const char* const  MPSS_DRIVER_VERSION   = "1.3.0 (mock)";
...
struct  Mpss3StackMock::PrivData
{
...
//============================================================================
/** @class    micmgmt::Mpss3StackMock  Mpss3StackMock.hpp
 *  @ingroup  sdk
 *  @brief    The class represents a mock MPSS 3.x stack class
 *
 *  The \b %Mpss3StackMock class encapsulates a mock MPSS 3.x stack.
 */
...
//----------------------------------------------------------------------------
/** @fn     Mpss3StackMock::Mpss3StackMock( int device )
 *  @param  device  Device number
 *
 *  Construct a MPSS 3.x stack object using specified \a device number.
 */

Mpss3StackMock::Mpss3StackMock( int device ) :
...
//----------------------------------------------------------------------------
/** @fn     Mpss3StackMock::~Mpss3StackMock()
 *
 *  Cleanup.
 */

Mpss3StackMock::~Mpss3StackMock()
{
    // Nothing to do (yet)
}
...
//----------------------------------------------------------------------------
/** @fn     std::string  Mpss3StackMock::mpssHomePath() const
 *  @return home path
 *
 *  Returns the MPSS home directory path.
 */

std::string  Mpss3StackMock::mpssHomePath() const
{
    return  userHomePath();
}
...
//----------------------------------------------------------------------------
/** @fn     std::string  Mpss3StackMock::mpssBootPath() const
 *  @return boot path
 *
 *  Returns the MPSS boot image directory path.
 */

std::string  Mpss3StackMock::mpssBootPath() const
{
	return  mpssHomePath();
}
...
//----------------------------------------------------------------------------
/** @fn     std::string  Mpss3StackMock::mpssFlashPath() const
 *  @return flash path
 *
 *  Returns the MPSS flash image directory path.
 */

std::string  Mpss3StackMock::mpssFlashPath() const
{
    return  mpssHomePath();
}
...
//----------------------------------------------------------------------------
/** @fn     uint32_t  Mpss3StackMock::getSystemDriverVersion( std::string* version ) const
...
uint32_t  Mpss3StackMock::getSystemDriverVersion( std::string* version ) const
{
    if (!version)
...
//----------------------------------------------------------------------------
/** @fn     uint32_t  Mpss3StackMock::getSystemDeviceNumbers( std::vector<size_t>* list ) const
...
uint32_t  Mpss3StackMock::getSystemDeviceNumbers( std::vector<size_t>* list ) const
{
    if (!list)
        return  MicDeviceError::errorCode( MICSDKERR_INVALID_ARG );
    ...
    for (size_t i=0; i<knl_cnt; i++)
        m_pData->mDevices.push_back( std::make_pair( i, eTypeUnknown ) );   // MPSS 3 should not detect KNL
    ...
    for (size_t i=knl_cnt; i<knl_cnt+knc_cnt; i++)
        m_pData->mDevices.push_back( std::make_pair( i, eTypeKnc ) );
...
//----------------------------------------------------------------------------
/** @fn     uint32_t  Mpss3StackMock::getSystemDeviceType( int* type, size_t number ) const
...
uint32_t  Mpss3StackMock::getSystemDeviceType( int* type, size_t number ) const
{
    if (!type)
        return  MicDeviceError::errorCode( MICSDKERR_INVALID_ARG );
...
//----------------------------------------------------------------------------
/** @fn     uint32_t  Mpss3StackMock::getSystemProperty( std::string* data, const std::string& name ) const
...
uint32_t  Mpss3StackMock::getSystemProperty( std::string* data, const std::string& name ) const
{
    if (!data || name.empty())
        return  MicDeviceError::errorCode( MICSDKERR_INVALID_ARG );
...
//----------------------------------------------------------------------------
/** @fn     uint32_t  Mpss3StackMock::getDeviceMode( int* mode ) const
...
uint32_t  Mpss3StackMock::getDeviceMode( int* mode ) const
{
    if (!mode)
        return  MicDeviceError::errorCode( MICSDKERR_INVALID_ARG );
...
//----------------------------------------------------------------------------
/** @fn     uint32_t  Mpss3StackMock::getDeviceState( int* state ) const
...
uint32_t  Mpss3StackMock::getDeviceState( int* state ) const
{
    if (!state)
        return  MicDeviceError::errorCode( MICSDKERR_INVALID_ARG );
...
//----------------------------------------------------------------------------
/** @fn     uint32_t  Mpss3StackMock::getDevicePciConfigData( PciConfigData* data ) const
...
uint32_t  Mpss3StackMock::getDevicePciConfigData( PciConfigData* data ) const
{
    if (!data)
        return  MicDeviceError::errorCode( MICSDKERR_INVALID_ARG );
...
//----------------------------------------------------------------------------
/** @fn     uint32_t  Mpss3StackMock::getDeviceProperty( std::string* data, const std::string& name ) const
 *  @param  data    Data return
 *  @param  name    Property name
 *  @return error code
 *
...
uint32_t  Mpss3StackMock::getDeviceProperty( std::string* data, const std::string& name ) const
{
    if (!data || name.empty())
        return  MicDeviceError::errorCode( MICSDKERR_INVALID_ARG );
...
//----------------------------------------------------------------------------
/** @fn     uint32_t  Mpss3StackMock::deviceReset( bool force )
 ...
 *
 *  This function will always return MICSDKERR_NOT_SUPPORTED.
 */

uint32_t  Mpss3StackMock::deviceReset( bool force )
{
